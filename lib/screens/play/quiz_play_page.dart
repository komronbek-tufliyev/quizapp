...
import 'package:quizapp/controllers/quiz_play_controller.dart';
...
class QuizPlayPage extends StatefulWidget {
  ...
  QuizPlayPage({super.key, required this.roomModel});
...
class _QuizPlayPageState extends State<QuizPlayPage> {
  late QuizPlayController quizPlayController;
  int showPage = 0;
  ...
  void initState() {
    super.initState();
    quizPlayController =
        Get.put(QuizPlayController(roomModel: widget.roomModel));
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(onWillPop: () async {
      final bool value = await showDialog(
          ...
          builder: (context) {
            return CustomDialog(
              ...
              title: "Quit",
              descriptionText: "You will get 0 points. Are you sure to quit?",
              actionWidgets: [
                InkWell(
                  onTap: () {
      ...
      return value;
    }, child: GetBuilder<QuizPlayController>(builder: (_) {
                          ...
                          children: [
                            TableRow(children: [
                              ...
                              Padding(
                                ...
                                child: CustomText(
                                  text: quizPlayController.roomModel.roomName,
                                  textColor: Colors.black,
                                  size: 16,
                                ),
                              ),
                            ...
                            TableRow(children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    bottom: Dimensions.height15),
                                child: CustomText(
                                  text: quizPlayController.roomModel.roomId,
                                  textColor: Colors.black,
                                  size: 16,
                                ),
                              ),
                            ...
                            TableRow(children: [
                              ...
                              CustomText(
                                text: quizPlayController.roomModel.quizName,
                                textColor: Colors.black,
                                size: 16,
                              ),
                            ]),
                  ...
                  Positioned(
                    ...
                    child: ButtonPressEffectContainer(
                      ...
                      onTapFunction: () async {
                        ...
                        bool result = await quizPlayController
                            .checkIfTheUserHasAlreadyPlayed();
                        if (result) {
                          await showErrorDialog(
                            description:
                                "You have already played this quiz. You can't play again.",
                          );
                          Get.back();
                        } else {
                          if (await quizPlayController
                              .setInitialPlayedUserScoreToZero()) {
                            setState(() {
                              showPage = 1;
                            });
                            Get.back();
  ...
  Widget QuizPage() {
    return GetBuilder<QuizPlayController>(builder: (_) {
